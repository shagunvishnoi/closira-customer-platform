...
2. No authentication. Every endpoint is public.
3. SOP matching is keyword-only. "I don't want to book" would still match the Booking SOP.
4. SQLite does not handle high concurrent writes well. Swap to PostgreSQL before any real traffic.